...
public class ItemKassa extends JFrame{
	...
	public ItemKassa(){
		...
		listOfNamesOfItems.addFocusListener(lForList);
		...
		totalPayLabel = new JLabel("Subtotaal: €0.0", JLabel.CENTER);
		...
		public void stateChanged(ChangeEvent e) {
			...
			if(e.getSource() == amountSpinner){
				...
				try{
					...
					totalPayLabel.setText("Subtotaal: €0.0");
				}
			}
	...
	private class ListenForList implements FocusListener{
